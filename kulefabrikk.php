...
if (isset($_REQUEST['antallkuler'])){
    ...
    if (($antallkuler * $prisprkule) > $penger) {
        ...
        if ($antallkuler > 1) {
            echo "<p style='color: #900a0a; text-align: center; margin-top: 280px;'>Du kjøpte " . $antallkuler . " kuler!</p>";
        } else {
            echo "<p style='color: #900a0a; text-align: center; margin-top: 280px;'>Du kjøpte " . $antallkuler . " kule!</p>";
        }
